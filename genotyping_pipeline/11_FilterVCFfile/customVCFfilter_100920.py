...
maxD={'C23':51,'MD18':63,'NCF02':54,'TMC02':52,'CM04':43,'CM05':51,
      'CM09':47,'CM12':54,'CM18':52,'CM29':49,'CM32':50,'CM33':46,
      'CRTB08':58,'CRTB18':42,'CRTB20':69,'CRTB24':64,'MD07':47,'MD08':50,'MD10':54,'MD16':47,
      'MD17':71,'NCF01':55,'NCF03':45,'NCF11':64,'NCM01':58,'NCM08':48,'TMC06':47,'TMC07':48,
      'TMC12':43,'TMC16':45,'TMC20':45,'TMC30':51}
...
### Fail sites with poor variant metrics
    ...
    if 'SOR' in d and float(d['SOR']) > 3.5:
