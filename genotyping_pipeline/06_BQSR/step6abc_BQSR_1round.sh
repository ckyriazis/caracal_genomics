#!/bin/bash
#$ -l highp,h_rt=60:00:00,h_data=12G
#$ -pe shared 4
#$ -N BQSR
#$ -cwd
#$ -m bea
#$ -o /u/home/c/ckyriazi/kirk-bigdata/caracals/output/genotyping_pipeline/06_BQSR
#$ -e /u/home/c/ckyriazi/kirk-bigdata/caracals/output/genotyping_pipeline/06_BQSR
#$ -M ckyriazi
