#! /bin/bash
#$ -wd /u/home/c/ckyriazi/project-klohmuel/caracal_pipeline/scripts/analysis/getNeutralRegions/step5
#$ -l h_rt=23:00:00,h_data=10G
#$ -pe shared 4
#$ -o /u/home/c/ckyriazi/project-klohmuel/caracal_pipeline/scripts/analysis/getNeutralRegions/step5/jobfiles/Blast_to_zebrafish.out.txt
#$ -e /u/home/c/ckyriazi/project-klohmuel/caracal_pipeline/scripts/analysis/getNeutralRegions/step5/jobfiles/Blast_to_zebrafish.err.txt
#$ -m abe
...
INDIR=/u/home/c/ckyriazi/kirk-bigdata/caracals/output/analysis/getNeutralRegions/step4
WORKDIR=/u/home/c/ckyriazi/kirk-bigdata/caracals/output/analysis/getNeutralRegions/step5
SCRIPTDIR=/u/home/c/ckyriazi/project-klohmuel/caracal_pipeline/scripts/analysis/getNeutralRegions/step5
REFDIR=/u/home/c/ckyriazi/project-klohmuel/caracal_pipeline/reference
REFERENCE=${REFDIR}/GCF_000181335.3_Felis_catus_9.0_genomic.fna
ZFISHDIR=/u/home/c/ckyriazi/project-klohmuel/caracal_pipeline/reference/zebraFish_genome
BLAST=/u/home/c/ckyriazi/project-klohmuel/software/ncbi-blast-2.13.0+/
