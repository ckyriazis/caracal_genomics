...
upper_bound = [1, 1, 0.1, 200] # 20 as upper bound on mig rec by dadi
p0 = [0.1,0.1,0.00005,20] # initial parameters; changing starting mu parameter because won't get permuted 
